...
class EnergyStationBrand
{
    ...
    #[Vich\UploadableField(mapping: 'energy_stations_brand_image', fileNameProperty: 'image.name', size: 'image.size', mimeType: 'image.mimeType', originalName: 'image.originalName', dimensions: 'image.dimensions')]
    public ?File $imageFile = null;

    #[ORM\Embedded(class: 'Vich\UploaderBundle\Entity\File')]
    private EmbeddedFile $image;

    #[Vich\UploadableField(mapping: 'energy_stations_brand_image', fileNameProperty: 'imageLow.name', size: 'imageLow.size', mimeType: 'imageLow.mimeType', originalName: 'imageLow.originalName', dimensions: 'imageLow.dimensions')]
